...
general['dataset_dir']=datasets/big-dataset


# PREPROCESS ARGS
preprocess['dataset_name']=big-dataset
preprocess['percent_train']=0.8
preprocess['percent_val']=0.1
preprocess['roboflow_name']='big-dataset'          # can be multiple directories
...
tune['resume_evolve']= # ../datasets/big-dataset/run1/tune_results/evolve_population.yaml                 # optional
tune['seed']=                           # optional
...
val['weights']=datasets/big-dataset/run3/train_results/weights/best.pt
...
test['weights']=datasets/big-dataset/run3/train_results/weights/best.pt
