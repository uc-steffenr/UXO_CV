...
general['imgsz']=640
general['opt']=SGD
general['project']=run3
general['dataset_dir']=datasets/noise1.8-rot15


# PREPROCESS ARGS
preprocess['dataset_name']=noise1.8-rot15
preprocess['percent_train']=0.8
preprocess['percent_val']=0.1
preprocess['roboflow_name']='noise1.8-rot15'          # can be multiple directories
...
tune['resume_evolve']= # ../datasets/noise1.8-rot15/run2/tune_results/evolve_population.yaml                 # optional
tune['seed']=                           # optional
tune['weights']=yolov5m.pt
...
train['hyp']=datasets/noise1.8-rot15/run2/tune_results/hyp_evolve.yaml
...
val['weights']=datasets/noise1.8-rot15/run3/train_results/weights/best.pt
...
test['weights']=datasets/noise1.8-rot15/run3/train_results/weights/best.pt
