...
tune['resume_evolve']= # ../datasets/noise1.8-rot15/run1/tune_results/evolve_population.yaml                 # optional
tune['seed']=                           # optional
...
train['hyp']=datasets/noise1.8-rot15/run1/tune_results/hyp_evolve.yaml
...
val['weights']=datasets/noise1.8-rot15/run1/train_results/weights/best.pt
...
test['weights']=datasets/noise1.8-rot15/run1/train_results/weights/best.pt
