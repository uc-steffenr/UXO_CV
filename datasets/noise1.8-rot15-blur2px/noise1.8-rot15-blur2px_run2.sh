...
general['dataset_dir']=datasets/noise1.8-rot15-blur2px


# PREPROCESS ARGS
preprocess['dataset_name']=noise1.8-rot15-blur2px
preprocess['percent_train']=0.8
preprocess['percent_val']=0.1
preprocess['roboflow_name']='noise1.8-rot15-blur2px'          # can be multiple directories
...
tune['resume_evolve']=../datasets/noise1.8-rot15-blur2px/run2/tune_results/evolve_population.yaml                 # optional
tune['seed']=                           # optional
...
train['hyp']=datasets/noise1.8-rot15-blur2px/run2/tune_results/hyp_evolve.yaml
...
train['noautoanchor']=false             # optional
train['patience']=50                      # optional
train['resume']=false # datasets/noise1.8-rot15-blur2px/run2/train_results/results.csv                        # optional
train['seed']=                          # optional
...
val['weights']=datasets/noise1.8-rot15-blur2px/run2/train_results/weights/best.pt
...
test['weights']=datasets/noise1.8-rot15-blur2px/run2/train_results/weights/best.pt
