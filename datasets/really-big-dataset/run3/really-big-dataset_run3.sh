...
tune['resume_evolve']= # ../datasets/big-dataset/run3/tune_results/evolve_population.yaml                 # optional
tune['seed']=                           # optional
...
val['weights']=datasets/really-big-dataset/run3/train_results/weights/best.pt
...
test['weights']=datasets/really-big-dataset/run3/train_results/weights/best.pt
